...
<script>
    ...
    var oiCommentBlockItemMvc = (function(){
        ...
        function init(pOptions){
            ...
            dhtmlxInit.init({
                'tpl': {
                    tree: {id: 'tplTreeBox', json: oiCommentBlockItemData.tplTree },
            ...
            if ( oiCommentBlockItemData.comData ){
                
                var varName = oiCommentBlockItemData.comData['actionId'];
                $(options.varName).val(varName);
                
                // ============= Шаблон списка комментариев
                var tplListFile = oiCommentBlockItemData.comData['tplListFile'];
                ...
                // ============= Шаблон комментария
                var tplComFile = oiCommentBlockItemData.comData['tplComFile'];
                // Устанавливаем скрытой переменой загруженное значение
