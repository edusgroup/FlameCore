...
<script type="text/javascript">
    ...
    var contrName = artListData.contid;
    var callType = 'comp';
    utils.setType(callType);
    utils.setContr(contrName);
    HAjax.setContr(contrName);

    var artListMvc = (function () {
        var options = {};
        var tree = {};
        //var treeCheckSel = [];
        //var treeCheckDel = [];
        ...
        function routeTreeDbClick(pTreeId, pTree) {
            $.fancybox.close();
            artListData.tplUrl = utils.getTreeUrlTpl(pTree, pTreeId);
            $('#' + options.tplUrlText).html(artListData.tplUrl);
        ...
        function initTrees() {
            dhtmlxInit.init({
                'contTree':{
                    tree:{
                        id:'contDiv', json:artListData.contTree
                    }, // tree
                    checkbox:true
                }, // contTree
                'routeTree':{
                    tree:{
                        id:'routeBox', json:artListData.routeTree
                    }, // tree
            ...
            for (var i in artListData.catalog) {
                var id = artListData.catalog[i];
